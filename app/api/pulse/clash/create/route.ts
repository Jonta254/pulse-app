...
import { createClash, isPulseDbReady } from "@/lib/pulse/db";
import { isRateLimited, noStoreJson, rateLimitResponse, readJsonBody } from "@/lib/serverApi";
import type { PulseClash } from "@/types/pulse";
...
export async function POST(req: NextRequest) {
  if (isRateLimited(req, "pulse-clash-create", 5)) {
