...
export const clientSeedMarkets: VerdexMarket[] = [
  // ── ⚡ FLASH (micro) ──────────────────────────────────────────────────────
  {
    ...
    outcome: null, yesPool: 480, noPool: 390, status: "open",
    featured: true, aiGenerated: false, totalBettors: 62,
  },
  {
    id: "verdex-flash-2",
    ...
    outcome: null, yesPool: 310, noPool: 420, status: "open",
    featured: false, aiGenerated: false, totalBettors: 38,
  },
  {
    id: "verdex-flash-3",
    ...
    outcome: null, yesPool: 220, noPool: 195, status: "open",
    featured: false, aiGenerated: false, totalBettors: 19,
  },
  ...
  // ── 🪙 CRYPTO ─────────────────────────────────────────────────────────────
  {
    ...
    outcome: null, yesPool: 5840, noPool: 3160, status: "open",
    featured: false, aiGenerated: false, totalBettors: 412,
  },
  {
    id: "verdex-eth-flip",
    ...
    outcome: null, yesPool: 2100, noPool: 7800, status: "open",
  ...
  },
  {
    ...
    outcome: null, yesPool: 3200, noPool: 4100, status: "open",
    featured: false, aiGenerated: false, totalBettors: 573,
  },
  ...
  // ── ⚽ SPORTS ─────────────────────────────────────────────────────────────
  {
    ...
    outcome: null, yesPool: 6100, noPool: 4800, status: "open",
    featured: false, aiGenerated: false, totalBettors: 1204,
  },
  {
    ...
    outcome: null, yesPool: 7200, noPool: 3100, status: "open",
    featured: false, aiGenerated: false, totalBettors: 941,
  },
  ...
  // ── 🌍 WORLD ──────────────────────────────────────────────────────────────
  {
    ...
    featured: false, aiGenerated: false, totalBettors: 327,
  },
  ...
  // ── 🎭 CULTURE ────────────────────────────────────────────────────────────
  {
    ...
    outcome: null, yesPool: 5500, noPool: 2800, status: "open",
    featured: false, aiGenerated: false, totalBettors: 688,
  },
];
