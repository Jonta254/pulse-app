/**
 * Minimal client-side seed — shown while /api/pulse/markets loads.
...
export const clientSeedMarkets: PulseMarket[] = [
  {
    id: "pulse-m1",
...
export const clientSeedLeaderboard: PulseLeaderEntry[] = [
